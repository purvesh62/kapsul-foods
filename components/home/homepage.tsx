      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="py-2 text-xl text-slate-600 max-w-2xl mx-auto flex gap-2 items-center justify-center">
              <Link 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {config.products.map((product: Product) => (
              <Card key={product.id} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg bg-white/80 backdrop-blur-sm">
      ...
      <section className="py-16 bg-white/60">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 text-center">
            {config.trustSection.map((item: TrustItem, index: number) => {
              const IconComponent = getIconComponent(item.icon);
              return (
                <div key={index} className="space-y-4">
                  <div className={`${item.bgColor} w-16 h-16 rounded-full flex items-center justify-center mx-auto`}>
